...
public class Matrix3 implements Serializable {
    ...
    public Matrix3 setToTranslation(Vector2 translation) {
        ...
        this.val[4] = 1.0f;
        this.val[5] = 0.0f;
        this.val[6] = translation.f165x;
        this.val[7] = translation.f166y;
        this.val[8] = 1.0f;
        return this;
    }
    ...
    public Matrix3 trn(Vector2 vector) {
        float[] fArr = this.val;
        fArr[6] = fArr[6] + vector.f165x;
        float[] fArr2 = this.val;
        fArr2[7] = fArr2[7] + vector.f166y;
        return this;
    }
    ...
    public Matrix3 trn(Vector3 vector) {
        float[] fArr = this.val;
        fArr[6] = fArr[6] + vector.f170x;
        float[] fArr2 = this.val;
        fArr2[7] = fArr2[7] + vector.f171y;
        return this;
    }
    ...
    public Matrix3 translate(Vector2 translation) {
        ...
        this.tmp[4] = 1.0f;
        this.tmp[5] = 0.0f;
        this.tmp[6] = translation.f165x;
        this.tmp[7] = translation.f166y;
        this.tmp[8] = 1.0f;
        mul(this.val, this.tmp);
        return this;
    }
    ...
    public Matrix3 scale(Vector2 scale) {
        this.tmp[0] = scale.f165x;
        this.tmp[1] = 0.0f;
        this.tmp[2] = 0.0f;
        this.tmp[3] = 0.0f;
        this.tmp[4] = scale.f166y;
        this.tmp[5] = 0.0f;
        this.tmp[6] = 0.0f;
        this.tmp[7] = 0.0f;
        this.tmp[8] = 1.0f;
    ...
    public Matrix3 scl(float scale) {
        ...
        fArr[0] = fArr[0] * scale;
        float[] fArr2 = this.val;
        fArr2[4] = fArr2[4] * scale;
        return this;
    }

    public Matrix3 scl(Vector2 scale) {
        float[] fArr = this.val;
        fArr[0] = fArr[0] * scale.f165x;
        float[] fArr2 = this.val;
        fArr2[4] = fArr2[4] * scale.f166y;
        return this;
    }
