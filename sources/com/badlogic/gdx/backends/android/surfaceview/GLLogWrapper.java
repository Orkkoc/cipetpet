...
class GLLogWrapper extends GLWrapperBase {
    ...
    private String getTextureEnvPName(int pname) {
        switch (pname) {
            ...
            case GL10.GL_TEXTURE_ENV_COLOR:
    ...
    private String getTextureEnvParamName(float param) {
        ...
        switch (iparam) {
            ...
            case 7681:
                return "GL_REPLACE";
            case GL10.GL_MODULATE:
                return "GL_MODULATE";
            case GL10.GL_DECAL:
                return "GL_DECAL";
            case GL11.GL_COMBINE:
                return "GL_COMBINE";
            default:
    ...
    private String getCap(int cap) {
        switch (cap) {
            case GL10.GL_POINT_SMOOTH:
                return "GL_POINT_SMOOTH";
            case GL10.GL_LINE_SMOOTH:
                return "GL_LINE_SMOOTH";
            case 2884:
                return "GL_CULL_FACE";
            case GL10.GL_LIGHTING:
                return "GL_LIGHTING";
            case GL10.GL_COLOR_MATERIAL:
            ...
            case GL10.GL_NORMALIZE:
                return "GL_NORMALIZE";
            case GL10.GL_ALPHA_TEST:
                return "GL_ALPHA_TEST";
            case 3024:
                return "GL_DITHER";
            case 3042:
                return "GL_BLEND";
            case GL10.GL_COLOR_LOGIC_OP:
            ...
            case GL10.GL_TEXTURE_COORD_ARRAY:
                return "GL_TEXTURE_COORD_ARRAY";
            case GL10.GL_MULTISAMPLE:
                return "GL_MULTISAMPLE";
            case 32926:
                return "GL_SAMPLE_ALPHA_TO_COVERAGE";
            case GL10.GL_SAMPLE_ALPHA_TO_ONE:
    ...
    private String getFogPName(int pname) {
        switch (pname) {
            case GL10.GL_FOG_DENSITY:
                return "GL_FOG_DENSITY";
            case GL10.GL_FOG_START:
                return "GL_FOG_START";
            case GL10.GL_FOG_END:
                return "GL_FOG_END";
            case GL10.GL_FOG_MODE:
                return "GL_FOG_MODE";
            case GL10.GL_FOG_COLOR:
                return "GL_FOG_COLOR";
            default:
                return getHex(pname);
        }
    ...
    private String getIntegerStateName(int pname) {
        switch (pname) {
            case GL10.GL_SMOOTH_POINT_SIZE_RANGE:
                return "GL_SMOOTH_POINT_SIZE_RANGE";
            case GL10.GL_SMOOTH_LINE_WIDTH_RANGE:
                return "GL_SMOOTH_LINE_WIDTH_RANGE";
            case GL10.GL_MAX_LIGHTS:
                return "GL_MAX_LIGHTS";
            case 3379:
                return "GL_MAX_TEXTURE_SIZE";
            case GL10.GL_MAX_MODELVIEW_STACK_DEPTH:
                return "GL_MAX_MODELVIEW_STACK_DEPTH";
            case GL10.GL_MAX_PROJECTION_STACK_DEPTH:
                return "GL_MAX_PROJECTION_STACK_DEPTH";
            case GL10.GL_MAX_TEXTURE_STACK_DEPTH:
    ...
    private String getHintTarget(int target) {
        switch (target) {
            case GL10.GL_PERSPECTIVE_CORRECTION_HINT:
                return "GL_PERSPECTIVE_CORRECTION_HINT";
            case GL10.GL_POINT_SMOOTH_HINT:
                return "GL_POINT_SMOOTH_HINT";
            case GL10.GL_LINE_SMOOTH_HINT:
                return "GL_LINE_SMOOTH_HINT";
            case 3155:
                return "GL_POLYGON_SMOOTH_HINT";
            case GL10.GL_FOG_HINT:
                return "GL_FOG_HINT";
            case 33170:
    ...
    private String getMaterialPName(int pname) {
        switch (pname) {
            case GL10.GL_AMBIENT:
                return "GL_AMBIENT";
            case GL10.GL_DIFFUSE:
                return "GL_DIFFUSE";
            case GL10.GL_SPECULAR:
                return "GL_SPECULAR";
            case GL10.GL_EMISSION:
                return "GL_EMISSION";
            case GL10.GL_SHININESS:
                return "GL_SHININESS";
            case GL10.GL_AMBIENT_AND_DIFFUSE:
    ...
    private String getLightPName(int pname) {
        switch (pname) {
            ...
            case GL10.GL_SPECULAR:
                return "GL_SPECULAR";
            case GL10.GL_POSITION:
                return "GL_POSITION";
            case GL10.GL_SPOT_DIRECTION:
                return "GL_SPOT_DIRECTION";
            case GL10.GL_SPOT_EXPONENT:
                return "GL_SPOT_EXPONENT";
            case GL10.GL_SPOT_CUTOFF:
                return "GL_SPOT_CUTOFF";
            case GL10.GL_CONSTANT_ATTENUATION:
                return "GL_CONSTANT_ATTENUATION";
            case GL10.GL_LINEAR_ATTENUATION:
                return "GL_LINEAR_ATTENUATION";
            case GL10.GL_QUADRATIC_ATTENUATION:
    ...
    private String getLightModelPName(int pname) {
        switch (pname) {
            case GL10.GL_LIGHT_MODEL_TWO_SIDE:
                return "GL_LIGHT_MODEL_TWO_SIDE";
            case GL10.GL_LIGHT_MODEL_AMBIENT:
