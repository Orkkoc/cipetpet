...
public class GLSurfaceView20 extends GLSurfaceView {
    ...
    public GLSurfaceView20(Context context, boolean translucent, int depth, int stencil, ResolutionStrategy resolutionStrategy2) {
        super(context);
        this.resolutionStrategy = resolutionStrategy2;
    ...
    private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
        ...
        private void printConfigs(EGL10 egl, EGLDisplay display, EGLConfig[] configs) {
            ...
            Log.w(GLSurfaceView20.TAG, String.format("%d configurations", new Object[]{Integer.valueOf(numConfigs)}));
