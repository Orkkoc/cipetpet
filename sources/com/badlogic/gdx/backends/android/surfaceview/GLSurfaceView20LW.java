...
public class GLSurfaceView20LW extends DefaultGLSurfaceViewLW {
    ...
    public GLSurfaceView20LW(WallpaperService.Engine engine, ResolutionStrategy resolutionStrategy2) {
        super(engine, resolutionStrategy2);
        this.resolutionStrategy = resolutionStrategy2;
        init(false, 16, 0);
    }

    public GLSurfaceView20LW(WallpaperService.Engine engine, boolean translucent, int depth, int stencil, ResolutionStrategy resolutionStrategy2) {
        super(engine, resolutionStrategy2);
        this.resolutionStrategy = resolutionStrategy2;
    ...
    static class ContextFactory implements GLBaseSurfaceViewLW.EGLContextFactory {
    ...
    private static class ConfigChooser implements GLSurfaceView.EGLConfigChooser {
        ...
        private void printConfigs(EGL10 egl, EGLDisplay display, EGLConfig[] configs) {
            ...
            Log.w(GLSurfaceView20LW.TAG, String.format("%d configurations", new Object[]{Integer.valueOf(numConfigs)}));
